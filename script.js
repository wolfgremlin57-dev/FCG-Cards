...
window.onload = () => {
    ...
    <div class="card-body" hidden>
                ...
                <p>Effect: ${card.effect?.replace(/AGGRESSIVE. /g, "<br><i>Aggressive.</i><br>").replace(/aGGRESSIVE. /g, "<i>Aggressive.</i><br>").replace(/aGGRESSIVe/g, "<i>Aggressive</i>").replace(/AGGRESSIVe. /g, "<br><i>Aggressive.</i> ")
                             ...
                             .replace(/ START OF YOUR OPPONENT'S TURN:/g, "<br><mark>Start of Your Opponent's Turn:</mark>").replace(/ WHEN PLAYED:/g, "<br><mark>When Played:</mark>").replace(/ When PLAYED/g, "<br><mark class = 'altyellow'>When Played</mark>").replace(/ WHEN Played:/g, "<br><mark class = 'red'>When Played:</mark>").replace(/ When PlayeD:/g, "<br><mark>Wh</mark><mark class = 'orange'>en Pl</mark><mark class = 'pastelpink'>ayed:</mark>").replace(/ whEn played/g, "<br><mark class = 'graftedorange'>When </mark><mark class = 'altyellow'>Played</mark>").replace(/ WHEn pLAYED:/g, "<br><mark class = 'green'>When Played:</mark>").replace(/ WHEN PLAYED/KILLED:/g, "<br><mark class = 'pastelpink'>When Played/Killed:</mark>")
